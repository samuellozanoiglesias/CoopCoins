...
python3 /home/samuel_lozano/hfsp_collective_learning/overcooked_original/GPU-Training-${type_agents}.py < layout-${cluster}-${layout}.txt > "$output_file" 2> "$error_file"